...
public class MainPageObject {
    ...
    public void swipeUp(int timeOfSwipe)
    {
        if (this.driver instanceof AppiumDriver) {
            ...
            System.out.println("Method swipeUp() does nothing on " + Platform.getInstance().getPlatform());
        }
    }
    ...
    public void swipeElementToLeft(String locator)
    {
        if (this.driver instanceof AppiumDriver) {
            ...
            System.out.println("Method swipeElementToLeft() does nothing on " + Platform.getInstance().getPlatform());
        }
